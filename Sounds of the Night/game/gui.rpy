...
define gui.accent_color = '#c6c5cc'

## The color used for a text button when it is neither selected nor hovered.
define gui.idle_color = '#7c8fa0'
...
define gui.muted_color = '#7b7a82'
define gui.hover_muted_color = '#aeabc6'
